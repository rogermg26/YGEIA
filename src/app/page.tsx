...
const HoverImage = () => {
  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', marginTop: '60px', marginBottom: '20px'}}>
        <HoveredImage src="/UPC.png" alt="First Image" buttonLabel="UPC" isHovered={hoveredImage === "first"} onMouseEnter={() => handleMouseEnter("first")} onMouseLeave={handleMouseLeave} onClick={() => handleButtonClick("UPC")}/>
        <div style={{ marginLeft: separation }} /> 
        <HoveredImage src="/YGEIA_.png" alt="Second Image" buttonLabel="YGEIA" isHovered={hoveredImage === "second"} onMouseEnter={() => handleMouseEnter("second")} onMouseLeave={handleMouseLeave} onClick={() => scrollToSection("aboutus")} />
        <div style={{ marginRight: separation }} />
        <HoveredImage src="/ICS.png" alt="Third Image" buttonLabel="ICS" isHovered={hoveredImage === "third"} onMouseEnter={() => handleMouseEnter("third")} onMouseLeave={handleMouseLeave} onClick={() => handleButtonClick("ICS")}/>
      </div>
      <div style={{ height: '100px' }}></div>
    </div>
  );
...
const handleButtonClick = (buttonName) => {
  ...
  switch (buttonName) {
      case "UPC":
          ...
          break;
      case "ICS":
          url = "https://ics.gencat.cat/ca/inici";
          break;
      default:
          // Handle default case
          break;
