...
export default function ProvesFactors() {
  ...
  useEffect(() => {
    ...
    console.log("UniqueVariables", Array.from(uniqueVariablesSet));
  }, [variableOptions]);
...
// TEMPORALITAT
  const fetchTemporalData = async () => {
    try {
      ...
      console.log("TemporalData", resultTemporal);
    } catch (error) {
      setError(error.message);
    }
  };
...
//  SEXE I EDAT
 const fetchAgeGroupData = async () => {
  try {
    ...
    console.log("AgeGroupData", resultAgeGroup);
  } catch (error) {
    setError(error.message);
  }
};
...
console.log("AgeGroupFormatted: ", groupedDataAgeGroup);
...
//   ALTRES
  ...
  console.log("GRUP: ", selectedGroup);
  console.log("VARIABLE: ", selectedVariable);
  console.log("CATEGORIA: ", selectedCategory);
  console.log("ID:", selectedId);
  console.log("SEX: ", selectedSex);
  console.log("AGEGROUP:", selectedAgeGroup);
  console.log("TEMPORALITY: ", selectedTemporality);
  console.log("SelectedYEAR", selectedYear, " TIPUS " , typeof selectedYear, typeof Number(selectedYear));
  console.log("SelectedMun", selectedMun);
