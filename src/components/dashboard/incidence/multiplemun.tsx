    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
             ...
             <ThemeProvider theme={theme}>
                ...
                <Button variant="contained" color="primary" onClick={() => setShowNormalized(false)} disabled={showNormalized === false}>
                    Dades No Normalitzades
                </Button>
                <Button variant="contained" color="primary" onClick={() => setShowNormalized(true)} disabled={showNormalized === true}>
                     Dades Normalitzades
                </Button>
            </ThemeProvider>
            </Box>
