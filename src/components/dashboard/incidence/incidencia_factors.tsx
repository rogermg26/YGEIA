...
const IncidenceInfo = () => {
  ...
  return (
    <>
    <section className="w-full max-w-full p-4 rounded" style={{ boxShadow: '0px 4px 6px rgba(0, 0, 0, 0.2)', backgroundColor: '#0C4160FF', color: 'white', fontFamily: 'Montserrat'}}>
      Comparativa de Factors
    </section>
    <section className="flex flex-col lg:flex-row gap-3 my-2">
      <div className="flex justify-center items-center w-full lg:w-1/2 h-[925px] rounded" style={{ backgroundColor: '#f8f8f8', boxShadow: '0px 4px 6px rgba(0, 0, 0, 0.2)' }}>
    ...
    <section className="w-full max-w-full p-4 rounded" style={{ boxShadow: '0px 4px 6px rgba(0, 0, 0, 0.2)', backgroundColor: '#0C4160FF', color: 'white', marginTop: '20px', fontFamily: 'Montserrat'}}>
      Incidència per Anys
    </section>
    <section>
