...
import BoxPlot from './mapes/boxplot';
...
const PrevalenceInfo = () => {
  ...
  return (
    ...
    <section className="flex flex-col lg:flex-row my-4 gap-3">
      <div className="flex flex-col justify-center items-center w-full lg:w-1/2 h-[600px] rounded" style={{ backgroundColor: '#f8f8f8', boxShadow: '0px 4px 6px rgba(0, 0, 0, 0.2)'}}>
        <Box display="flex" gap={2} mb={2}>
             <ThemeProvider theme={theme}>
                ...
                <Button variant="contained" color={normalizedData === false ? 'secondary' : 'primary'} onClick={() => setNormalizedData(false)}>
                    Dades No Normalitzades
                </Button>
                <Button variant="contained" color={normalizedData === true ? 'secondary' : 'primary'} onClick={() => setNormalizedData(true)}>
                     Dades Normalitzades
                </Button>
            </ThemeProvider>
            </Box>
      ...
      <section className="flex flex-col lg:flex-row my-4 gap-3">
      <div className="flex flex-col items-center w-full lg:w-1/2 h-[625px] rounded" style={{ backgroundColor: '#f8f8f8', boxShadow: '0px 4px 6px rgba(0, 0, 0, 0.2)' }}>
