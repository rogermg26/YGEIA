...
const theme = createTheme({
  palette: {
    ...
    secondary: {
      main: '#273377', // Green color from MUI palette
    },
  },
});
  ...
  return (
    ...
    <Box display="flex" gap={2} mb={2}>
      <ThemeProvider theme={theme}>
        <Button variant="contained"  color={selectedOption === 'sex' ? 'secondary' : 'primary'} onClick={() => setSelectedOption('sex')}>
          Filtra per Sexe
        </Button>
        <Button variant="contained"  color={selectedOption === 'age' ? 'secondary' : 'primary'} onClick={() => setSelectedOption('age')}>
          Filtra per Grups d'Edat
        </Button>
        <Button variant="contained"  color={selectedOption === 'total' ? 'secondary' : 'primary'} onClick={() => setSelectedOption('total')} >
          Mostra el Total
        </Button>
